...
# AIOX Project Navigator Activator
...
## Activation Protocol
1. Load `.aiox-core/development/agents/navigator.md` as source of truth (fallback: `.codex/agents/navigator.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .aiox-core/development/scripts/generate-greeting.js navigator` and show it first.
