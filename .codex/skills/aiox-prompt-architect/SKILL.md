...
# AIOX System Prompt Architect Activator
...
## Activation Protocol
1. Load `.aiox-core/development/agents/prompt-architect.md` as source of truth (fallback: `.codex/agents/prompt-architect.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .aiox-core/development/scripts/generate-greeting.js prompt-architect` and show it first.
