...
2. Read the agent memory file: `.aios-core/development/agents/ux-design-expert/MEMORY.md`
3. Read the agent context (authority, rules, config): `.aios-core/development/agents/ux-design-expert/agent-context.md`
