...
2. Read the agent memory file: `.aios-core/development/agents/data-engineer/MEMORY.md`
3. Read the agent context (authority, rules, config): `.aios-core/development/agents/data-engineer/agent-context.md`
