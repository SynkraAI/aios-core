 ...
 * IDE Configuration Metadata
 *
 * Synkra AIOX v4 supports 7 main IDEs/CLIs:
 * - Claude Code (Anthropic's official CLI) - Recommended
 * - Codex CLI (OpenAI coding CLI) - Recommended
...
const IDE_CONFIGS = {
  ...
  grok: {
    name: 'Grok Build',
    description: '',
    // Compact always-on rules; full agents/skills/hooks come from grok-skills-sync
    configFile: path.join('.grok', 'rules', 'aiox-core.md'),
    template: 'ide-rules/grok-rules.md',
    requiresDirectory: true,
    format: 'text',
    recommended: true,
    // Do not set agentFolder — Grok agents are generated by sync:skills:grok
    // (native frontmatter), not by the generic copyAgentFiles pipeline.
  },
  gemini: {
    name: 'Gemini CLI',
    description: '',
