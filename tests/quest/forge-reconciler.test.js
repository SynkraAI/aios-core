...
// ===========================================================================
// Unit tests: MODE_TO_PACK
// ===========================================================================

describe('MODE_TO_PACK', () => {
  test('maps STRESS_TEST mode to stress-test-sprint pack', () => {
    expect(MODE_TO_PACK.STRESS_TEST).toBe('stress-test-sprint');
  });
});
