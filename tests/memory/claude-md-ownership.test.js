...
describe('CLAUDE.md Ownership Annotations', () => {
  ...
  test('annotation count matches expected sections (8 framework + 5 project = 13 total, but Otimizacao is framework = 9 + 5)', () => {
    ...
    // 5 PROJECT-CUSTOMIZED: Padroes, Testes, Git, Comandos, Debug
    expect(projectMatches.length).toBe(5);
  });
