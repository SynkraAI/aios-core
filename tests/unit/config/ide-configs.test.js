...
describe('IDE Configs', () => {
  describe('IDE_CONFIGS', () => {
    ...
    it('should have correct config file paths', () => {
      ...
      expect(IDE_CONFIGS.grok.configFile).toContain('.grok');
    ...
    it('should have correct agent folder paths', () => {
      ...
      // Grok has no agentFolder — generated by sync:skills:grok
      expect(IDE_CONFIGS.grok.agentFolder).toBeUndefined();
