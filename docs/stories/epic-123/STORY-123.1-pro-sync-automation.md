...
- `package.json` (`aios-pro`)
- `squads/README.md` (`aios-pro`)
- `scripts/validate-publish-surface.js` (`aios-pro`)
- `.github/workflows/ci.yml` (`aios-pro`)
- `.github/workflows/publish.yml` (`aios-pro`)
- `.github/workflows/sync-aiox-core.yml` (`aios-pro`)
