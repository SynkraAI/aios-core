...
commands:
  ...
  # Gotchas Memory (Knowledge Base of discovered issues)
...
dependencies:
  checklists:
    ...
    - self-critique-checklist.md  # Mandatory self-review before completion
  tasks:
    - apply-qa-fixes.md
    - qa-fix-issues.md            # QA fix loop (8-phase workflow)
...
- `*capture-insights` - Capture session discoveries
