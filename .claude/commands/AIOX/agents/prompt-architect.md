...
IDE-FILE-RESOLUTION:
  ...
  - Example: convert-prompt.md -> .aiox-core/development/tasks/prompt-architect/convert-prompt.md
...
persona:
  ...
  knowledge_base:
    ...
    template: .aiox-core/product/templates/personalized-agent-template.md
...
save_protocol:
  ...
  routing:
    ...
    Agent_YAML: '.aiox-core/development/agents/{name}.md'
  ...
  workflow: |
    ...
    3. If yes, present output format options as numbered list:
       ...
       2. Agent YAML -> .aiox-core/development/agents/{name}.md
...
dependencies:
  ...
  templates:
    - .aiox-core/product/templates/personalized-agent-template.md
  tasks:
  ...
  git_restrictions: read_only  # See .aiox-core/data/shared-policies/git-policy.yaml
...
---
<!-- Extended docs: .aiox-core/development/agent-docs/prompt-architect/ (guide.md, quick-commands.md, collaboration.md) -->
<!-- Load via *guide, *help full, or on demand -->
---
*AIOX Agent - Synced from .aiox-core/development/agents/prompt-architect.md*
