...
echo "=== Instalando DOCX Processing Skill ==="
echo ""

if [ ! -f "SKILL.md" ]; then
  echo "❌ Erro: Execute no diretório do skill DOCX"
  exit 1
fi
...
if command -v npm >/dev/null 2>&1; then
  ...
  echo "   ⚠️  npm não encontrado (opcional)"
fi
...
echo "   3. Instale ferramentas externas:"
