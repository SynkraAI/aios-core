 ...
 * Extends the base effects from lp-generator with 6 LP-specific effects.
 */

import { EFFECTS_PRESETS as BASE_PRESETS, getEffectsConfig as getBaseEffectsConfig } from './effects-config.mjs';
