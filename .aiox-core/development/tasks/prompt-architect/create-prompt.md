...
**If Agent YAML format**, use the template at `.aiox-core/product/templates/personalized-agent-template.md` and include:
...
Before presenting, run every item from `.aiox-core/development/checklists/prompt-architect/quality-checklist.md`:
