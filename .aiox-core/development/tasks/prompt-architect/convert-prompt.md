...
If Agent YAML is selected, use the template at `.aiox-core/product/templates/personalized-agent-template.md`.
...
Run the conversion checklist (`.aiox-core/development/checklists/prompt-architect/conversion-checklist.md`) against the output before presenting to the user.
