---
name: aiox-qa
description: "an autonomous AIOX QA agent spawned to execute a specific mission"
...
3. **Gotchas**: Read `.aiox/gotchas.json` (filter for QA-relevant: Testing, Quality, Security, Performance)
