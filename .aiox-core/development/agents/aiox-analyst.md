---
name: aiox-analyst
description: "an autonomous AIOX Analyst agent spawned to execute a specific mission"
...
3. **Gotchas**: Read `.aiox/gotchas.json` (filter for Analyst-relevant: Market, Research, Strategy, Data)
4. **Technical Preferences**: Read `.aiox-core/data/technical-preferences.md`
5. **Project Config**: Read `.aiox-core/core-config.yaml`
6. **AIOX KB**: Read `.aiox-core/data/aiox-kb.md` for framework knowledge
