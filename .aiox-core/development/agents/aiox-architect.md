---
name: aiox-architect
description: "an autonomous AIOX Architect agent spawned to execute a specific mission"
...
3. **Gotchas**: Read `.aiox/gotchas.json` (filter for Architect-relevant: Architecture, Security, Performance, Scalability)
