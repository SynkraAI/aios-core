---
name: aiox-po
description: "an autonomous AIOX Product Owner agent spawned to execute a specific mission"
...
3. **Gotchas**: Read `.aiox/gotchas.json` (filter for PO-relevant: Backlog, Stories, Epic-Context, Prioritization)
