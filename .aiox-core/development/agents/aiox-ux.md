---
name: aiox-ux
description: "an autonomous AIOX UX Design Expert agent spawned to execute a specific mission"
...
3. **Gotchas**: Read `.aiox/gotchas.json` (filter for UX-relevant: Frontend, UI, Components, Accessibility, Design)
...
7. **Design Data**: Read `.aiox-core/product/data/design-opinions.md` if design decisions needed
