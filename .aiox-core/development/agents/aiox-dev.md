---
name: aiox-dev
description: "an autonomous AIOX Developer agent spawned to execute a specific mission"
...
2. **Project Memory** (CRITICAL — read BEFORE planning):
   ...
   - Read `.aiox-core/data/memory/user/luiz-fosc-profile.md` (user preferences)
3. **Gotchas**: Read `.aiox/gotchas.json` (filter for Dev-relevant: Frontend, React, Backend, API, Database)
