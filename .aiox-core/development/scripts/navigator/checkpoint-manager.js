...
async function createCheckpoint(options = {}) {
  ...
  const checkpointDir = `.aiox/navigator/${projectName}/checkpoints`;
...
function loadCheckpoint(checkpointId, projectName) {
  const filepath = `.aiox/navigator/${projectName}/checkpoints/${checkpointId}.md`;
...
**Checkpoint ID:** ${data.checkpointId}
**Snapshot Path:** \`.aiox/navigator/${data.projectName}/checkpoints/${data.checkpointId}.md\`
